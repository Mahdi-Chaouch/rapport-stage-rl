...
<div className="my-auto max-w-6xl mx-auto text-center space-y-8">
  ...
  >
    ...
    <br />
    <span className="text-sm font-sans not-italic uppercase tracking-[0.25em] text-neutral-500 font-normal mt-4 block">
      {global.heroLocation}
    </span>
  </motion.p>

  {/* CTA Button → Première Escale */}
  <motion.div
    initial={{ opacity: 0, y: 20 }}
    animate={{ opacity: 1, y: 0 }}
  ...
  >
    <button
      ...
      className="group relative inline-flex items-center space-x-3 px-8 py-4 rounded-full bg-white text-black font-sans text-xs tracking-[0.25em] uppercase font-bold hover:bg-neutral-200 trans[...]
    >
    ...
    <button
      ...
      className="inline-flex items-center space-x-3 px-8 py-4 rounded-full bg-black/60 border border-white/20 text-white font-sans text-xs tracking-[0.25em] uppercase font-semibold hover:borde[...]
    >
